...
(defrule print-banner
  ...
  (assert (items (itemname Baseball_bat) (quantity 1) (price 39.99)))
  (assert (items (itemname Tennis_racket) (quantity 1) (price 29.99)))
  (assert (items (itemname Badminton_racket) (quantity 1) (price 29.99)))
  (assert (items (itemname Cricket_ball) (quantity 1) (price 24.99)))
  (assert (items (itemname Baseball_ball) (quantity 1) (price 39.99)))
  (assert (items (itemname Tennis_ball) (quantity 1) (price 69.99)))
  (assert (items (itemname Cricet_bat) (quantity 1) (price 29.99)))
  (assert (items (itemname Shuttle_cork) (quantity 1) (price 9.99)))
